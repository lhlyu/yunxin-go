...
const _API_HISTORY_QUERY_SESSION_MSG_URL = "https://api.netease.im/nimserver/history/querySessionMsg.action"
...
// 单聊云端历史消息查询
func (y *YunxinIM) ApiHistoryQuerySessionMsg(param *HistoryQuerySessionMsgParam) *ImResp {
	return y.PostFrom(_API_HISTORY_QUERY_SESSION_MSG_URL, param)
}
